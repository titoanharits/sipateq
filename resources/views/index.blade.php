...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">SIPATEK</a>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h1 class="text-uppercase text-white font-weight-bold">SIPATEK</h1>
          <hr class="divider my-4">
        </div>
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">Mboh gatau sistem e kayak apa, pokok bikin halaman login sek</p>
          <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">HIYAA</a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="text-white mt-0">Apa Saja Fitur SIPATEK?</h2>
          <hr class="divider light my-4">
          <p class="text-white-50 mb-4">Mboh gatau sistem e kayak apa, pokok bikin halaman login sek</p>
