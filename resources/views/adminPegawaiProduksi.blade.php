  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Register Pegawai Produksi</h4>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="form-panel">
          <div class="form">
            <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action="{{ route('tambahPegawaiProduksi') }}">
              @csrf
              ...
              <div class="form-group ">
                <label for="no_hp" class="control-label col-lg-2">Nomor HP</label>
                <div class="col-lg-10">
                  <input class="form-control " id="no_hp" name="no_hp" type="no_hp">
                </div>
              </div>
